...
export const LoginButton = ({ children, onClick }: { children: string, onClick?: () => void }) => {
    return <button onClick = {onClick} type="submit" className="w-full h-full text-center font-semibold rounded-lg focus:ring-blue-200 focus:none focus:outline-none hover:opacity-90 disabled:opacity-80 disabled:hover:opacity-80 relative overflow-hidden text-sm px-3 py-1.5 mr-4 ">
